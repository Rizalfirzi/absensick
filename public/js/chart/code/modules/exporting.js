        ...
        r(B.prototype, {
            sanitizeSVG: function (a, b) {
                if (b && b.exporting && b.exporting.allowHTML) {
                    ...
                    e &&
                        e[1] &&
                        ((e = '\x3cforeignObject x\x3d"0" y\x3d"0" width\x3d"' + b.chart.width + '" height\x3d"' + b.chart.height + '"\x3e\x3cbody xmlns\x3d"http://www.w3.org/1999/xhtml"\x3e' + e[1] + "\x3c/body\x3e\x3c/foreignObject\x3e"),
                ...
                a = a
                    ...
                    .replace(/url\([^#]+#/g, "url(#")
                    .replace(/<svg /, '\x3csvg xmlns:xlink\x3d"http://www.w3.org/1999/xlink" ')
                    .replace(/ (NS[0-9]+\:)?href=/g, " xlink:href\x3d")
                    .replace(/\n/, " ")
                    .replace(/<\/svg>.*?$/, "\x3c/svg\x3e")
                    .replace(/(fill|stroke)="rgba\(([ 0-9]+,[ 0-9]+,[ 0-9]+),([ 0-9\.]+)\)"/g, '$1\x3d"rgb($2)" $1-opacity\x3d"$3"')
                    .replace(/&nbsp;/g, "\u00a0")
                    .replace(/&shy;/g, "\u00ad");
            ...
            getSVG: function (a) {
                ...
                h(this.series, function (a) {
                    v = n(a.userOptions, { animation: !1, enableMouseTracking: !1, showCheckbox: !1, visible: a.visible });
            ...
            getSVGForExport: function (a, b) {
                ...
                return this.getSVG(n({ chart: { borderRadius: 0 } }, e.chartOptions, b, { exporting: { sourceWidth: (a && a.sourceWidth) || e.sourceWidth, sourceHeight: (a && a.sourceHeight) || e.sourceHeight } }));
            },
            ...
            contextMenu: function (a, b, e, c, v, m, g) {
                var d = this,
                    ...
                    A;
                l ||
                    ((d[n] = l = p("div", { className: a }, { position: "absolute", zIndex: 1e3, padding: x + "px" }, d.container)),
                    (y = p("div", { className: "highcharts-menu" }, null, l)),
                    u(y, r({ MozBoxShadow: "3px 3px 10px #888", WebkitBoxShadow: "3px 3px 10px #888", boxShadow: "3px 3px 10px #888" }, t.menuStyle)),
                    (A = function () {
                        u(l, { display: "none" });
                        g && g.setState(0);
                        d.openMenu = !1;
                ...
                if (!1 !== c.enabled) {
                    ...
                    c.symbol &&
                        ((g = e
                            ...
                            .attr({ zIndex: 1 })
                            .add(d)),
                        g.attr({ stroke: c.symbolStroke, fill: c.symbolFill, "stroke-width": c.symbolStrokeWidth || 1 }));
